...
var parteAbajo ="<div class='col-md-4'>"
					+"<div class='single_widget wow fadeIn' data-wow-duration='2s'>"
						...
						+"<div class='single_widget_info'>"
							+"<p>"
								...
								+"<div class='phone_email'>Tel: 605 19 65 01</div>"
								...
								+"<div class='footer_socail_icon Insta'>"
									...
									+"</div>"
									+"<div>"
										+"<a href='politicas.html' style='color:yellow;'>Politica de privacidad</a>"
										+"<a style='color:yellow;display:block;' href='Cookies.html'>Politica de cookies</a>"
									+"</div>"
								+"</div>"
							+"</p>"
						+"</div>"
				...
				+"<div class='col-md-4'>"
					+"<div class='single_widget wow fadeIn' data-wow-duration='4s'>"
						...
						+"<div class='single_widget_info'>"
							+"<div>"
								+"<a href='https://www.google.com/maps?ll=39.188611,-0.436522&z=18&t=m&hl=es&gl=ES&mapclient=embed&cid=8801043269333629544' style='color:yellow;'>Plaça Carbó N1 - Algemesí - Valencia</a>"
							+"</div>"
						...
						+"<div class='single_widget_form text-left'>"
							+"<form id='formid' method='post' >"
								+"<div class='form-group'>"
									+"<input id='Nombre' type='text' class='form-control' name='nombre' placeholder='Nombres'>"
								+"</div>"
								+"<div class='form-group'>"
									+"<input id='Tel' type='text' class='form-control' name='tel' placeholder='Telefono'>"
								+"</div>"
								+"<div class='form-group'>"
